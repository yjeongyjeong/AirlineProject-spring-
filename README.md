...
[✈️ 사이트 바로가기 ✈️](http://3.35.70.253:8081/)

⛔ 카카오 로그인 redirect 수정이 완료되지 않아 일반 로그인만 가능합니다.

⛔ 메일 내 링크 또한 url 수정이 완료되지 않아 이동이 불가합니다.

⛔ 항공 스케줄의 년도를 수정하지 않아 22~23년을 기준으로 검색 및 예약 가능합니다.

⛔ 이 외에도 수정되지 않은 오류가 많습니다. 최대한 빠르게 수정할 예정이니 양해부탁드립니다😅
